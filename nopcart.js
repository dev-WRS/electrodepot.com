...
if( fTotal < 50 )       // When the ttl is less than 50.00 - shipping is 12.85
   fShipping = 12.85; 
else if( fTotal < 100 )    // When the ttl is less than 100.00 - shipping is 17.50
   fShipping = 17.50; 
else if( fTotal < 400 ) // When the ttl is less than 400.00 - shipping is 19.98
   fShipping = 19.98; 
else if( fTotal < 800 ) // When the ttl is less than 800.00 - shipping is 25.30
   fShipping = 25.30; 
else if( fTotal < 1200 ) // When the ttl is less than 1200.00 - shipping is 38.00
   fShipping = 38; 
else if( fTotal < 2000 ) // When the ttl is less than 2000.00 - shipping is 52.00
   fShipping = 52; 
else 
fShipping = 62.50;       // When the ttl is 2000 or more - shipping is 62.50
