...
BEGIN
{
  ...
  $postmaster        = '';
 @referers          = qw(attr.com www.attr.com controlsupply.com edplc.com electrodepot.com migro.com aluminio.com attf.com 5y6.com attcontrol.com attf.com abbcorp.com amaint.com aquiesta.com abbdepot.com abbc.info localhost);
 @allow_mail_to     = qw(edplc.com attr.com attf.com electrodepot.com migro.com aluminio.com controlsupply.com aquesta.com);
  @recipients        = ();
  %recipient_alias   = ();
...
sub success_page_return_link {
  ...
  if ($self->{FormConfig}{return_link_url} and $self->{FormConfig}{return_link_title}) {
    print "<ul>\n";
    print '<li><a href="../../kennedy_tom/seatowel.com/bL03582.00-tempT22LH/tempT22LH/cgi-bin/%27,%20$self-%3Eescape_html($self-%3E%7BFormConfig%7D%7Breturn_link_url%7D),%0A%20%20%20%20%20%20%20%27">', $self->escape_html($self->{FormConfig}{return_link_title}), "</a>\n";
    print "</li>\n</ul>\n";
  }
}
